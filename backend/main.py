...
async def lifespan(app: FastAPI):
    print(">>> Renewable Energy Advisor API starting...")
...
app = FastAPI(
    title="Renewable Energy Advisor API",
    description="Parallel AI agents for environmental & financial analysis of renewable energy adoption in Tunisia.",
    version="1.0.0",
    lifespan=lifespan,
)
...
@app.post("/analyse", response_model=ParallelAnalysisResponse)
...
@app.post("/analyse/env", response_model=AgentResult)
...
@app.post("/analyse/finance", response_model=AgentResult)
...
@app.post("/analyse/energie", response_model=AgentResult)
...
@app.post("/analyse/expert", response_model=AgentResult)
