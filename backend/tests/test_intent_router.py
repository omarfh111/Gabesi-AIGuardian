...
def test_diagnosis_intent_routing(mock_run_diag, mock_llm_cls):
...
def test_irrigation_intent_routing(mock_run_irr, mock_llm_cls):
...
def test_pollution_qa_routing(mock_run_qa, mock_llm_cls):
...
@patch("app.agents.intent_router.ChatOpenAI")
def test_pollution_report_requires_farmer_id(mock_llm_cls):
...
@patch("app.agents.intent_router.ChatOpenAI")
def test_unknown_intent_returns_clarification(mock_llm_cls):
