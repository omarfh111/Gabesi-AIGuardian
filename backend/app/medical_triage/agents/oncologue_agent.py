...
- **MANDATORY CLARIFICATION BEFORE TRANSFER**: Unless there is an immediate life-threatening red flag, ask at least one targeted oncologic clarification question before using `[SUGGEST_TRANSFER: toxicologist]`.
...
4. **Treatment Plan / Diagnostic Plan**
